...
```{r}
descriptors.cors <- read.csv("https://raw.githubusercontent.com/jeremyfprice/litreview/master/data/lit_review-descriptors-cors-el.csv", header = TRUE)

library(igraph)
set.seed(1234)                # for reproducible example
g  <- graph.adjacency(descriptors.cors, weighted=TRUE)
g <- simplify(g)
